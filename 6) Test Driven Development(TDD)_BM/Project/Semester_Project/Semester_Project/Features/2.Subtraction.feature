...
@tag3
Scenario Outline: Verified the output of the process of subtraction on following.
	Given Open the windowApp
	When Fill all data in given model to test it
	| S.NO | Input_1 | Input_2 | Expected_output | Error_Message                                                         |
	| 001  | 2       | 2       | 7               | The process of subtraction two number is not working (on basic input) |
	| 002  | 2       | 5       | 4               | The process of subtraction two number is not working (on basic input) |
